const app = getApp()
const DB = wx.cloud.database().collection("submit5")
let score1 = 0
...
Page({
  ...
  stepbackward(){
    wx.redirectTo({
      url: "/pages/submitsystem/G43submit/G43submit"
    })
  },
  // 删除照片 
            ...
            if (!that.data.imgbox.length) {
              ...
              for (let i = 0; i < that.data.imgbox.length; i++) {
                promiseArr.push(new Promise((reslove, reject) => {
                  ...
                  str = num.toString()
                  wx.cloud.uploadFile({
                    cloudPath: 'G42/' + new Date().getTime() + str , // 上传至云端的路径
